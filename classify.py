...
def classify(document):
    ...
    print(scores, word_alphas, sentence_alphas, words_in_each_sentence)
...
if __name__ == '__main__':
    file = pd.read_csv('pfam_file/domain_doc.csv',header=None)
    label = file[0][10]
    document=file[1][10].replace(' .','.')
    print(label)
    classify(document)
    # print(document)
