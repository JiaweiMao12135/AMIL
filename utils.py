...
def read_csv(csv_folder, split, sentence_limit, word_limit):
    ...
    data = pd.read_csv(os.path.join(csv_folder, split + '.csv'), header=None,encoding='utf-8',engine='python')
...
def create_input_files(csv_folder, output_folder, sentence_limit, word_limit, min_word_count=5,
    ...
    train_docs, train_labels, word_counter = read_csv(csv_folder, 'train1', sentence_limit, word_limit)
